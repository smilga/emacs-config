...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
	(evil-magit evli-magit magit powerline rainbow-mode json-mode evil-commentary auto-highlight-symbol dumb-jump evil-mc evil-multiedit multiedit evil evil-mode color-theme color-themes auto-complete counsel swiper ace-window which-key try use-package))))
(custom-set-faces
